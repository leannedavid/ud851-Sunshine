...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED (35) Add a private com.example.android.sunshine.ForecastAdapter variable called mForecastAdapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (41) set mForecastAdapter equal to a new com.example.android.sunshine.ForecastAdapter
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                showWeatherDataView();
                // COMPLETED (45) Instead of iterating through every string, use mForecastAdapter.setWeatherData and
